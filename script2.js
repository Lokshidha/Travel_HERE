...
// Add the following function in your JavaScript code
function searchLocation() {
    var userInput = document.getElementById('search-input').value;
    geocode(platform, userInput);
}

// Modify the geocode function to accept user input
function geocode(platform, userInput) {
  ...
  function onSuccess(result) {
    ...
    */
    ...
    if (locations.length > 0) {
        ...
        openBubble(locations[0].position, locations[0].address.label);
    }
    // ... etc.
  }
